...
def plot_precision_recall_paper(precisions_50, precisions_75, precisions_85):
    ...
    axs[0,0].plot(x, fasterrcnn_rgb_50["small"], label="RGB", linewidth=3, alpha=0.9)
    axs[0,0].plot(x, fasterrcnn_rgbdif_50["small"], label="DIF", linewidth=3, alpha=0.9)
    axs[0,0].plot(x, fasterrcnn_pol_50["small"], label="POL", linewidth=3, alpha=0.9)
    axs[0,1].plot(x, fasterrcnn_rgb_50["medium"], label="RGB", linewidth=3, alpha=0.9)
    axs[0,1].plot(x, fasterrcnn_rgbdif_50["medium"], label="DIF", linewidth=3, alpha=0.9)
    axs[0,1].plot(x, fasterrcnn_pol_50["medium"], label="POL ", linewidth=3, alpha=0.9)
    axs[0,2].plot(x, fasterrcnn_rgb_50["large"], label="RGB ", linewidth=3, alpha=0.9)
    axs[0,2].plot(x, fasterrcnn_rgbdif_50["large"], label="DIF ", linewidth=3, alpha=0.9)
    axs[0,2].plot(x, fasterrcnn_pol_50["large"], label="POL ", linewidth=3, alpha=0.9)
    axs[1,0].plot(x, fasterrcnn_rgb_75["small"], label="RGB", linewidth=3, alpha=0.9)
    axs[1,0].plot(x, fasterrcnn_rgbdif_75["small"], label="DIF", linewidth=3, alpha=0.9)
    axs[1,0].plot(x, fasterrcnn_pol_75["small"], label="POL", linewidth=3, alpha=0.9)
    axs[1,1].plot(x, fasterrcnn_rgb_75["medium"], label="RGB", linewidth=3, alpha=0.9)
    axs[1,1].plot(x, fasterrcnn_rgbdif_75["medium"], label="DIF", linewidth=3, alpha=0.9)
    axs[1,1].plot(x, fasterrcnn_pol_75["medium"], label="POL", linewidth=3, alpha=0.9)
    axs[1,2].plot(x, fasterrcnn_rgb_75["large"], label="RGB", linewidth=3, alpha=0.9)
    axs[1,2].plot(x, fasterrcnn_rgbdif_75["large"], label="DIF", linewidth=3, alpha=0.9)
    axs[1,2].plot(x, fasterrcnn_pol_75["large"], label="POL", linewidth=3, alpha=0.9)
    axs[2,0].plot(x, fasterrcnn_rgb_85["small"], label="RGB", linewidth=3, alpha=0.9)
    axs[2,0].plot(x, fasterrcnn_rgbdif_85["small"], label="DIF", linewidth=3, alpha=0.9)
    axs[2,0].plot(x, fasterrcnn_pol_85["small"], label="POL", linewidth=3, alpha=0.9)
    axs[2,1].plot(x, fasterrcnn_rgb_85["medium"], label="RGB", linewidth=3, alpha=0.9)
    axs[2,1].plot(x, fasterrcnn_rgbdif_85["medium"], label="DIF", linewidth=3, alpha=0.9)
    axs[2,1].plot(x, fasterrcnn_pol_85["medium"], label="POL", linewidth=3, alpha=0.9)
    axs[2,2].plot(x, fasterrcnn_rgb_85["large"], label="RGB", linewidth=3, alpha=0.9)
    axs[2,2].plot(x, fasterrcnn_rgbdif_85["large"], label="DIF", linewidth=3, alpha=0.9)
    axs[2,2].plot(x, fasterrcnn_pol_85["large"], label="POL", linewidth=3, alpha=0.9)
